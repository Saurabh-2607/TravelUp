const ArticlePreview = ({title, excerpt, category, readingTime, image }) => {
    return (
        <div className="inline-flex justify-start items-center gap-5">
            <div 
                className="w-100 h-79 bg-black/30 relative overflow-hidden" 
                style={{
            ...
            <div className="inline-flex flex-col justify-start items-start gap-6">
                <div className="flex flex-col justify-start items-start gap-2">
                    ...
                    <div className="w-2/3 justify-start text-black text-4xl font-bold leading-10">{title}</div>
                    <div className="w-2/3 justify-start text-neutral-400 text-lg font-normal leading-relaxed">{excerpt}</div>
                </div>
