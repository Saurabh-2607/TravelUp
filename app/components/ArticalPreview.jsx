const ArticlePreview = ({title, excerpt, category, readingTime, image }) => {
    // Function to trim excerpt to exactly 9 words
    ...
    return (
        <div className="inline-flex justify-start items-center gap-5">
            ...
            <div className="inline-flex flex-col justify-start items-start gap-2">
                ...
                <button className="w-40 h-14 px-2 py-2 s-font bg-black text-white font-semibold text-sm hover:bg-gray-800 transition">
                    Read more
                </button>
            </div>
        </div>
